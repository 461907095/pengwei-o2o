$(function() {
    ...
    var pageSize = 3;
    // 列出商品列表的URL
    var listUrl = '/imooc/frontend/listproductbyshop';
    // 默认的页码
    var pageNum = 1;
    // 从地址栏里获取ShopId
    ...
    var searchDivUrl = '/imooc/frontend/listshopdetailpageinfo?shopId=' + shopId;
    ...
    // $('#exchangelist').attr('href', '/imooc/frontend/awardlist?shopId=' +
    // shopId);
    // 获取本店铺信息以及商品类别信息列表
    ...
    $('.list-div').on(
        ...
        function(e) {
            ...
            window.location.href = '/imooc/frontend/productdetail?productId='
                + productId;
        });
